...
class K7Statistic(Enum):
    ...
    SALES_RTG000_SUM = 'SalesRtg000Sum'
    ...
    STAND_RTG_PER_SUM = 'StandRtgPerSum'
    SALES_RTG_PER_SUM = 'SalesRtgPerSum'
    STAND_SALES_RTG_PER_SUM = 'StandSalesRtgPerSum'
    ...
    SALES_RTG000_AVG = 'SalesRtg000Avg'
    ...
    STAND_RTG_PER_AVG = 'StandRtgPerAvg'
    SALES_RTG_PER_AVG = 'SalesRtgPerAvg'
    STAND_SALES_RTG_PER_AVG = 'StandSalesRtgPerAvg'
